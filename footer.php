<footer class="full-row bg-secondery text-white footer-1 py-80">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-logo mb-4"> <img class="logo-bottom" src="img/logo/logo2.png" alt="Foter logo"> </div>
                <div class="mb-5">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="footer-widget get-in-touch icon-primary">
                    ...
                    <ul>
                        <li><i class="fas fa-map-marker-alt"></i>Deniyaya, Akurassa, Matara.</li>
                        <li><a href="mailto:info@sinharajaecovilla.com"><i class="fas fa-envelope"></i>info@sinharajaecovilla.com</a></li>
                        <li><a href="tel:+94-77-248-3697"><i class="fas fa-phone"></i>+94-77-248-3697</a></li>
                    </ul>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="footer-widget quick-link">
                    ...
                    <ul>
                        ...
                        <li><a href="accomadation.php">- Accomadation</a></li>
