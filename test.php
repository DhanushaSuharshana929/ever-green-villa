...
<html lang="en">
    ...
    <!-- Mirrored from unicoderbd.com/theme/html/vilena/light/room-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Aug 2019 08:24:38 GMT -->
            ...
            <div class="row">
                ...
                <div class="full-row overlay-secondery-opacity-65 bg-img-5" id="page-banner">
                    <div class="container">
                        <div class="row py-80">
                            <div class="col-sm-6">
                                <h1 class="banner-title text-white">Room Details</h1>
                            </div>
                            <div class="col-sm-6">
                                <ul class="pages-link">
